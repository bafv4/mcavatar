...
__export(core_exports, {
  DEFAULT_FULLBODY_OPTIONS: () => DEFAULT_FULLBODY_OPTIONS,
  DEFAULT_OPTIONS: () => DEFAULT_OPTIONS,
  POSES: () => POSES,
  STEVE_UUID: () => STEVE_UUID,
  createCustomPose: () => createCustomPose,
  formatUuid: () => formatUuid,
  generateAvatar: () => generateAvatar,
  generateFullBody: () => generateFullBody,
  getPose: () => getPose,
  validatePose: () => validatePose,
